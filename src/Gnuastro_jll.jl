...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Gnuastro_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("0a420f0b-933a-5d4b-986a-eca9d80f9bfc"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Gnuastro", artifacts_toml) for e in artifacts["Gnuastro"]]
...
if best_platform === nothing
    @debug("Unable to load Gnuastro; unsupported platform $(triplet(platform_key_abi()))")
else
